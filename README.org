...
tools and request parameters.  It also has an overall timeout, a model/tool
round limit and bounded retries for transient transport failures.  The relevant
options are =gptel-agent-task-timeout=, =gptel-agent-max-request-rounds=,
